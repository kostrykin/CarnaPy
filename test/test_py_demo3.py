...
test_tools.assert_rendering('py.demo3.regions', rc.result)
...
with cpy.SingleFrameContext((512, 512), fov=90, near=1, far=1000) as rc:
    ...
    rc.dvr(diffuse_light=1, sample_rate=500)
    rc.camera.rotate((1.5, 1, 0), 25, 'deg').translate(10, -25, 130).rotate((0, 0, 1), 35, 'deg')
    rc.mask(ndi.label(data0 > 0.2)[0], 'regions-on-top', spacing=(1, 1, 1), color=(1, 0, 0, 1))

test_tools.assert_rendering('py.demo3.regions-on-top', rc.result)
...
test_tools.assert_rendering('py.demo3.borders-on-top', rc.result)
...
test_tools.assert_rendering('py.demo3.borders-in-background', rc.result)
